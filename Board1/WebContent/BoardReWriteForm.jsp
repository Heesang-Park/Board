		...
		<center>
			...
			<tbody>
				<tr height="40">
					...
					<td width="400"><input type="text" name="writer" size="60" style="border:none; background: transparent;">
					</td>
				</tr>
				<tr height="40">
					<th width="200" align="center">제목</th>
					<td width="400"><input type="text" name="subject" size="60" value="[답글]" style="border:none; background: transparent;">
					</td>
				</tr>
				<tr height="40">
					<th width="200" align="center">이메일</th>
					<td width="400"><input type="text" name="email" size="60" style="border:none; background: transparent;">
					</td>
				</tr>
				<tr height="40">
					<th width="200" align="center">패스워드</th>
					<td width="400"><input type="text" name="password" size="60" style="border:none; background: transparent;">
					</td>
				</tr>
				<tr height="40">
					<th width="200" align="center">글내용</th>
					<td width="400"><textarea rows="10" cols="60" name="contents" style="border:none; background: transparent;">
					</textarea>
					</td>
				</tr>	
				<tr height="40">
					<th colspan="2" align="center">
						...
						<input type="hidden" value="${re_level }" name="re_level">	 
					 	...
					 	<input type="button" value="전체글보기" onclick="location.href='BoardListCon.do'"></th>
				</tbody>
			</table>
		</center>
		</form>		
